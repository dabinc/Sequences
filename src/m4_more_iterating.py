...
def run_test_sum_sequence():
    ...
    # ------------------------------------------------------------------
    # TO DO: 2. READ the COMMENTS and CODE in this function,
...
def run_test_count_positive_sines():
    ...
    # ------------------------------------------------------------------
    # TOD O: 6. Implement this TEST function.
    ...
    # Test 11
    expected = 2
    actual = count_positive_sines([1, 3])
    print()
...
def run_test_sum_first_n():
    ...
    # ------------------------------------------------------------------
    # TOD O: 8. Implement this TEST function.
